...
case class WnodeKindMatchError_NoValue(snak: Snak) extends Reason(errCode = Reason.wnodeKindMatchError_NoValue)
case class WnodeKindMatchError_SomeValue(snak: Snak) extends Reason(errCode = Reason.wnodeKindMatchError_SomeValue)
case class MatchDatatypeError_NoValue(snak: Snak) extends Reason(errCode = Reason.wnodeKindMatchError_SomeValue)
