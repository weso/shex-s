...
case class Schema(
  ...
  /** Get a shape with label
    ...
    * @param lbl
    * @return
    *   the shape expression with that label
    */
  ...
  /** Start shape expression in a schema
    *
    * @return
    *   the start shape expression if it has been declared or the first one. None if there are no shape expressions
    */
...
object Schema {
  ...
  /** Read a Schema from a file This version is unsafe in the sense that it can throw exceptions Use `fromPath` for a
    * safe version which returns an `IO[Schema]`
    *
    * @param path
    *   file to read
    * @param format
    *   it can be CompactFormat or JsonFormat
    * @return
    *   the schema
    */
  def unsafeFromPath(
  ...
  /** Read a Schema from a file This version is unsafe in the sense that it can throw exceptions Use `fromPath` for a
    ...
    *
    * @param str
    *   string that represents the schema
    * @param format
    *   it can be CompactFormat or JsonFormat
    * @return
    *   the schema
