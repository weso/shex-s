...
trait BagMatchers extends FunSuite {
  def matchBag[A: Show](rbe: Rbe[A], bag: Bag[A], open: Boolean = true)(implicit
      loc: munit.Location
  ): Unit =
  ...
  def noMatchBag[A: Show](rbe: Rbe[A], bag: Bag[A], open: Boolean = true)(implicit
      loc: munit.Location
  ): Unit =
  ...
  def notContainsBag[A: Show](rbe: Rbe[A], bag: Bag[A], open: Boolean = true)(implicit
      loc: munit.Location
  ): Unit =
