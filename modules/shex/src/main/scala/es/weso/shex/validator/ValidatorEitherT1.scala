...
case class ValidatorEitherT1(
  ...
  private def checkShapeDeclAbstract(
    ...
    info(
      s"ShapeDeclAbstract(${node.show}, ${showSE(sd)}, withDescendants: [${withDescendants
  ...
  private def checkShapeBase(
    ...
    info(s"checkShapeBase(${node.show}@{${showSE(s)}}, flatShape? ${s
