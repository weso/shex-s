      ...
      case l: Literal =>
        l.dataType match {
          case `xsd:decimal` |
              ...
              `xsd:integer` | `xsd:nonPositiveInteger` | `xsd:negativeInteger` | `xsd:nonNegativeInteger` | `xsd:long` |
              `xsd:unsignedLong` | `xsd:positiveInteger` | `xsd:unsignedInt` | `xsd:unsignedShort` |
              `xsd:unsignedByte` | `xsd:int` | `xsd:short` | `xsd:byte` =>
            for {
