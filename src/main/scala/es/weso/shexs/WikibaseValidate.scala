...
object WikibaseValidate {
  ...
  lazy val prefixMapPath: Opts[Option[Path]] = Opts
    .option[Path]("prefixMapPath", "path containing prefix map declarations (Wikidata by default)")
    .orNone
